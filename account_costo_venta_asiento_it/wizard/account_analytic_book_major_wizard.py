...
group by almacen_id,product_id, cuenta_salida, cuenta_valuacion	
	...
	""")
		...
		self.env.cr.execute("""
				select cuenta_salida, sum(costo_ventas) from view_costo_venta_it
				group by cuenta_salida	
			""")
		...
		self.env.cr.execute("""
				select cuenta_valuacion, sum(costo_ventas) from view_costo_venta_it
				group by cuenta_valuacion	
			""")
